...
// Import models
const User = require('../api/src/models/user.model');
const Product = require('../api/src/models/product.model');
const Warranty = require('../api/src/models/warranty.model');
  ...
  try {
    ...
    for (let i = 0; i < 10; i++) {
      const product = new Product({
        ...
        category: faker.helpers.arrayElement(['Electronics', 'Appliances', 'Furniture', 'Automotive', 'Tools']),
